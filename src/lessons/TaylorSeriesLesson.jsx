...
import TaylorPolynomials from "../components/taylor/TaylorPolynomials"
import 'katex/dist/katex.min.css';
import ParametricPlot from "../components/taylor/ParametricPlot";
import LinearApproximation from "../components/taylor/LinearApproximation";
import { ital, bold, mathy, latexblock } from "../utils/formattingHelpers";
import TwoGraphs from "../components/taylor/TwoGraphs";
import QuadraticApproximation from "../components/taylor/QuadraticApproximation";
import FresnelApproximation from "../components/taylor/FresnelApproximation";
import ParametricPlotSlider from "../components/taylor/ParametricPlotSlider";

function TaylorSeriesLesson() {
    ...
    return <div className="taylor-project">
        <h1>
            Taylor Series: Intuition and Applications
        </h1>

        <div className="taylor-lesson">
...
export default TaylorSeriesLesson;
